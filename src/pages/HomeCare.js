        ...
        {auth.user ? (
            <div>
                ...
                <Form style={{maxWidth: 900, margin: '50px auto', padding: '5px 5px'}} onSubmit={handleSubmit}>
                    ...
                    <Form.Row>
                        <Col sm={3}><Form.Label style={{padding: 5}}>From Time:</Form.Label></Col>
                        <Col sm={1}>
                    ...
                    <Form.Row>
                        <Col sm={3}><Form.Label style={{padding: 5}}>To Time:</Form.Label></Col>
                        <Col sm={1}>
                            <input type='time' min='9:00' max='18:00'/>
                        </Col>
                        <Col sm={3}><Form.Label style={{padding: 5}}>Example: 2:00 PM</Form.Label></Col>
                        ...
                        <div>
                            {paymentCompleted ? (
                                ...
                                <div>
                                    ...
                                    <PaymentForm amountDue='50' isDone={setPaymentCompleted}/>
                                </div>
                            )}
